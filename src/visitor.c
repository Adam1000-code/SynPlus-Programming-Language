...
AST_T* visitor_visit(visitor_T* visitor, AST_T* node, list_T* list)
{
    switch(node->type)
    {
        case AST_COMPOUND:
            ...
            break;
        case AST_ASSIGNMENT:
            return visitor_visit_assignment(visitor, node, list);
            break;
        case AST_VARIABLE:
            return visitor_visit_variable(visitor, node, list);
            break;
        case AST_CALL:
            return visitor_visit_call(visitor, node, list);
            break;
        case AST_INT:
            return visitor_visit_int(visitor, node, list);
            break;
        case AST_ACCESS:
            return visitor_visit_access(visitor, node, list);
            break;
        case AST_FUNCTION:
            return visitor_visit_function(visitor, node, list);
            break;
        case AST_STRING:
            return visitor_visit_string(visitor, node, list);
            break;
        default:
